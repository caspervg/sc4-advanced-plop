 ...
 * - Top: Buildings table (~60% height) with virtualized scrolling
 * - Bottom: Lots detail table (~40% height) for selected building
 */
...
private:
    ImGuiTexture LoadBuildingTexture_(uint32_t buildingInstanceId);
